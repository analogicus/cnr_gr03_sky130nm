...
def main(name):
  ...
  bool_values_n40 = [False, False, False, False, False, False, False, False]
  ...
  bool_values_0 = [False, False, False, False, False, False, False, False]
  ...
  bool_values_27 = [False, False, False, False, False, False, False, False]
  ...
  bool_values_75 = [False, False, False, False, False, False, False, False]
  ...
  bool_values_125 = [False, False, False, False, False, False, False, False]
  ...
  x_125 = np.int8(int_value)

  print(x_125)


  plt.plot([-40, 0, 25, 75, 125], [x_n40, x_0, x_27, x_75, x_125])
