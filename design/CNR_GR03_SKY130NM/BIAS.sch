...
C {CNR_ATR_SKY130NM/CNR_ATR_SKY130NM/CNRATR_NCH_4C2F0.sym} -540 -30 0 1 {name=x2 }
...
C {devices/iopin.sym} -730 350 0 1 {name=p2 lab=VSS}
C {SUN_TR_SKY130NM/SUNTR_RPPO8.sym} -580 230 1 0 {name=x3 }
